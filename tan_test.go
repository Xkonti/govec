...
func TestV2F_TanInPlace(t *testing.T) {
	...
	if !almostEqual(v1.Y, 1, 1e-10) || !almostEqual(v1.Y, 1, 1e-10) {
...
func TestV3F_Tan(t *testing.T) {
	...
	if !almostEqual(v2.X, 0, 1e-10) || !almostEqual(v2.Y, 1, 1e-10) || !almostEqual(v2.Z, 0, 1e-10) {
...
func TestV3F_TanInPlace(t *testing.T) {
	...
	if !almostEqual(v1.Y, 1, 1e-10) || !almostEqual(v1.Y, 1, 1e-10) || !almostEqual(v1.Z, 0, 1e-10) {
...
func TestV2I_Tan(t *testing.T) {
	...
	if !almostEqual(v2.X, 0, 1e-10) || !almostEqual(v2.Y, math.Tan(1), 1e-10) {
...
func TestV3I_Tan(t *testing.T) {
	...
	if !almostEqual(v2.X, 0, 1e-10) || !almostEqual(v2.Y, math.Tan(1), 1e-10) || !almostEqual(v2.Z, math.Tan(3), 1e-10) {
